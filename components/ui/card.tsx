...
function Card({
    ...
    return (
        <div
            ...
            data-size={size}
            className={cn(
                'overflow-hidden border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900 group/card flex flex-col',
                size === 'sm' && 'border-2 p-4',
                size === 'default' && 'rounded-sm border-2 p-6',
                className
            )}
            {...props}
        />
